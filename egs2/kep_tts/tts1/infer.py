...
spk_dict = {
    ...
    '성인_남자_18': 35, '성인_남자_19': 40, '성인_여자_0': 3, '성인_여자_1': 4, '성인_여자_2': 5, '성인_여자_3': 9, 
    ...
    '성인_여자_22': 44, '어린이_여자_0': 45, '어린이_여자_1': 46, '어린이_여자_2': 47, '어린이_남자_0': 48, '어린이_남자_1': 49, 
    '어린이_남자_2': 50, '추가1': 51, '추가2': 52, '추가3': 53, '추가1': 54, '추가4': 51, '추가5': 55, 
}
# np.array(spk_dict[sid])
...
for i in range(1, 5):
    ...
    sids = np.array(i)
    speech, _ = sf.read('/workspace/TTS/sample/test.wav')
...
print("rtf: ", total / total_length) # 0.24
exit()
pitch = 0
ctrl_speed = 1
ctrl_loudness = 0
